...
class CurrentDestruction extends StrictObject
{
    ...
    private \DrdPlus\Destruction\Destruction $destruction;
    ...
    private ?\DrdPlus\RollsOn\QualityAndSuccess\RollOnQuality $currentRollOnDestructing = null;
    private ?\Granam\DiceRolls\Roll $robotRollOnDestructing = null;
